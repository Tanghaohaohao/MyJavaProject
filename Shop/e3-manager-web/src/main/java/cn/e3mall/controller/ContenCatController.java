 ...
 */
@Controller
public class ContenCatController {
	...
	public E3Result updateContentCatgory(long id,String name) {
		E3Result e3Result = contentCategoryService.updateContentCatgory(id, name);
		return e3Result;
	}
	...
	public E3Result deleteContentCatgory(long id) {
		E3Result e3Result = contentCategoryService.deleteContentCatgory(id);
		return e3Result;
	}
}
